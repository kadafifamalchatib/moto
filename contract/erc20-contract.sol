...
contract MotoranToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xC20a9C7bfb23713f4B4011d73552646953f57567); // Marketing Address
    address payable public charityAddress = payable(0xC20a9C7bfb23713f4B4011d73552646953f57567); // Charity/Dev Address
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private salePrice = 5000;// 0.01*50=50 token for 0.01 bnb (set as per requirements)
